...
public class Assignment2part3 extends WindowProgram {
    ...
    private void drawPawprint(double x, double y) {
        //first toe
        GOval toe = new GOval(x+FIRST_TOE_OFFSET_X, y+FIRST_TOE_OFFSET_Y, TOE_WIDTH, TOE_HEIGHT);
        toe.setFilled(true);
        toe.setFillColor(Color.BLACK);
        add(toe);

        //second toe
        toe = new GOval(x + SECOND_TOE_OFFSET_X, y + SECOND_TOE_OFFSET_Y, TOE_WIDTH, TOE_HEIGHT);
        toe.setFilled(true);
        toe.setFillColor(Color.BLACK);
        add(toe);

        //third toe
        toe = new GOval(x+THIRD_TOE_OFFSET_X, y+THIRD_TOE_OFFSET_Y, TOE_WIDTH, TOE_HEIGHT);
        toe.setFilled(true);
        toe.setFillColor(Color.BLACK);
        add(toe);
